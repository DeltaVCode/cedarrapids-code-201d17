...
function handleLocationSubmit(event) {
  ...
  if (state.allLocationsRef.indexOf(name) > -1) {
    state.allCookieStands[state.allLocationsRef.indexOf(name)].minCustomers =
      minCustomers;
    state.allCookieStands[state.allLocationsRef.indexOf(name)].maxCustomers =
      maxCustomers;
    state.allCookieStands[state.allLocationsRef.indexOf(name)].aveCookies =
      aveCookies;
